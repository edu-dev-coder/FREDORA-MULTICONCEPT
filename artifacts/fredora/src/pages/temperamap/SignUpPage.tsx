          ...
          <div className="px-8 py-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <p className="text-center text-xs text-muted-foreground">
                ...
                {" "}and{" "}
                <a href="/temperamap/privacy" className="text-accent hover:underline">Privacy Policy</a>
              </p>
            </form>

            <div className="relative my-6">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-[#eaedf3]"></div>
              </div>
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full border border-[#c8d0e0] rounded-lg py-3 px-4 text-sm font-medium text-foreground hover:bg-gray-50 transition-colors"
            >
