...
function mockApiPlugin(): Plugin {
  ...
  const divisions = [
    {
      ...
      description: "Delivering wholesome food products, gourmet event catering, artisan confectioneries, and dependable agro-commodity supply chains.",
      bannerColor: "from-blue-600 to-blue-800",
      comingSoon: false,
      imageUrl: null,
      sortOrder: 0,
      services: [
        { id: 101, divisionSlug: "foods", name: "Premium Confectioneries & Bakery", description: "Freshly baked artisan pastries, nutrient-rich loaves of bread, and custom celebration cakes.", price: "From ₦5,000", imageUrl: null, sortOrder: 0 },
        { id: 102, divisionSlug: "foods", name: "Corporate & Event Gourmet Catering", description: "Full-service hygienic gourmet catering for weddings, executive conferences, and private banquets.", price: "Custom Quote", imageUrl: null, sortOrder: 1 },
        { id: 103, divisionSlug: "foods", name: "Agro-Commodity Bulk Supply", description: "Hygienically packaged staple food items and wholesale bulk delivery for families and institutions.", price: "Market Rate", imageUrl: null, sortOrder: 2 },
      ],
      createdAt: now,
      updatedAt: now,
    },
  ...
  let products = [
    ...
    { id: 2, divisionSlug: "chems", name: "Sparkle Multipurpose Liquid Detergent (5L)", description: "High-foaming antibacterial household cleaning formula for floors, kitchens, and surfaces.", price: "₦6,500", imageUrl: null, sortOrder: 0, createdAt: now },
    { id: 3, divisionSlug: "chems", name: "Radiance Nourishing Body Glow Cream (250ml)", description: "Gentle, non-greasy cosmetic skincare cream enriched with shea butter and vitamin E.", price: "₦5,200", imageUrl: null, sortOrder: 1, createdAt: now },
    { id: 4, divisionSlug: "chems", name: "PureCare Antibacterial Hand Wash (500ml)", description: "Moisturizing hygienic hand wash formulated with skin-soothing aloe vera.", price: "₦2,400", imageUrl: null, sortOrder: 2, createdAt: now },
    { id: 5, divisionSlug: "chems", name: "Industrial Degreaser X-10 (20L)", description: "Heavy duty non-corrosive industrial cleaning formula.", price: "₦35,000", imageUrl: null, sortOrder: 3, createdAt: now },
    { id: 6, divisionSlug: "eduservices", name: "One-on-One Private Tutor Placement Pack", description: "Vetted home tutor onboarding package with diagnostic assessment and monthly progress tracking.", price: "₦35,000", imageUrl: null, sortOrder: 0, createdAt: now },
    { id: 7, divisionSlug: "eduservices", name: "School Teachers Pedagogy Training Course", description: "Comprehensive teacher upskilling on modern student engagement, classroom management, and assessment techniques.", price: "₦50,000", imageUrl: null, sortOrder: 1, createdAt: now },
    { id: 8, divisionSlug: "scents", name: "Elegance Extrait De Parfum (50ml)", description: "Long-lasting amber and woody floral extrait.", price: "₦28,000", imageUrl: null, sortOrder: 0, createdAt: now },
  ];
