            ...
            <Card>
              <CardContent className="p-5">
                ...
                <p className="text-xs text-muted-foreground mt-3">
                  Your partner will need to sign in or create a free account to take the assessment. Their payment is covered by your Couples Test purchase.
                </p>
              </CardContent>
            </Card>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 p-3 rounded-lg bg-primary/5">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">No payment required — covered by your purchase</p>
                </div>
              </div>
              <div className="flex items-start gap-3 p-3 rounded-lg bg-primary/5">
