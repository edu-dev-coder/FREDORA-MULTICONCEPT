        ...
        <div className="prose prose-slate max-w-none space-y-8 text-foreground">
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-2">
              ...
              <li><strong className="text-foreground">Payment information:</strong> Transaction references processed through Paystack. We do not store your card details — these are handled entirely by Paystack</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-2">
              <li><strong className="text-foreground">Service providers:</strong> Trusted third parties who help us deliver our service (e.g., Paystack for payment processing, Clerk for authentication). These parties are bound by confidentiality agreements</li>
